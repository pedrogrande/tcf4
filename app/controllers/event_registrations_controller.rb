class EventRegistrationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_registration.save
        format.html { redirect_to event_registration_thanks_path, notice: 'Event registration was successfully created.' }
        EventRegistrationMailerJob.new.async.perform(@event_registration.id)
      else
  ...
  private
    ...
    def event_registration_params
      params.require(:event_registration).permit(:event_id, :first_name, :last_name, :email, :phone)
    end
end
