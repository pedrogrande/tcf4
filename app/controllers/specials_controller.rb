class SpecialsController < ApplicationController
  ...
  def create
    ...
    @special.admin_id = current_user.id
  ...
  private
    ...
    def special_params
      params.require(:special).permit(:admin_id, :recipient_email, :popular_programme_id, :weekend_programme_id, :dollar_discount, :percent_discount, :guid, :date_redeemed)
    end
end
