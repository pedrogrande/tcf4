class EnrolmentsController < ApplicationController
  ...
  def thanks
    ...
    EnrolmentMailerJob.new.async.perform(@enrolment.id)
    UpdateStudentNumberJob.new.async.perform(@enrolment.id)
  end
  # GET /enrolments/1
  ...
  private
    ...
    def enrolment_params
      params.require(:enrolment).permit(:about, :first_name, :last_name, :phone, :email, :address, :suburb, :state, :postcode, :country, :popular_programme_id, :weekend_programme_id, :paid, :special_id)
    end
end
