...
Unit.create!([
  {name: "Programming Fundamentals", tagline: "Programming basics", description: "Programming yeah!", duration_minutes: 90, icon: "code", unit_code: "PS01", workshop_credits: 15, online_credits: 3, active: true, skill_group_id: 2},
  {name: "HTML5 & CSS3", tagline: "Basic web design", description: "Web design basics", duration_minutes: 90, icon: "code", unit_code: "WD01", workshop_credits: 15, online_credits: 3, active: true, skill_group_id: 4},
  {name: "Basic Bootstrap", tagline: "Make your websites and apps look amazing with Bootstrap", description: "Bootstrap!!", duration_minutes: 90, icon: "code", unit_code: "WD02", workshop_credits: 15, online_credits: nil, active: true, skill_group_id: 4},
  {name: "Ruby on Rails Introduction", tagline: "Programming", description: "RoR", duration_minutes: 180, icon: "code", unit_code: "WAD02", workshop_credits: 30, online_credits: 6, active: true, skill_group_id: 3},
  {name: "Rails Debugging", tagline: "Solving those errors", description: "Learn how to solve your own errors", duration_minutes: 90, icon: "code", unit_code: "WAD20", workshop_credits: 15, online_credits: nil, active: true, skill_group_id: 3},
  {name: "Google Maps for your app", tagline: "Integrating Google Maps", description: "Where are you?", duration_minutes: 90, icon: "code", unit_code: "WAD30", workshop_credits: 15, online_credits: 3, active: true, skill_group_id: 3},
  {name: "In-app messaging", tagline: "When you need to get in touch", description: "Allows your users to message each other", duration_minutes: 180, icon: "code", unit_code: "WAD31", workshop_credits: 30, online_credits: 6, active: true, skill_group_id: 3},
  {name: "Project - Build your first Rails app", tagline: "Build your own web app", description: "Build your own web app", duration_minutes: 180, icon: "code", unit_code: "WADP01", workshop_credits: 30, online_credits: 6, active: true, skill_group_id: 3}
])
UnitSkill.create!([
  ...
  {unit_id: 6, skill_id: 1, before_skill_level: 1, after_skill_level: 2},
  {unit_id: 6, skill_id: 4, before_skill_level: 1, after_skill_level: 2},
  {unit_id: 6, skill_id: 6, before_skill_level: 1, after_skill_level: 2},
...
UserSkill.create!([
  {user_id: 5, skill_id: 6, skill_level: 0},
  {user_id: 5, skill_id: 7, skill_level: 1},
  {user_id: 5, skill_id: 8, skill_level: 1},
  {user_id: 5, skill_id: 10, skill_level: 0},
  {user_id: 5, skill_id: 11, skill_level: 0},
  {user_id: 5, skill_id: 1, skill_level: 3},
  {user_id: 5, skill_id: 2, skill_level: 3},
  {user_id: 5, skill_id: 3, skill_level: 3},
  {user_id: 5, skill_id: 4, skill_level: 2},
  {user_id: 5, skill_id: 5, skill_level: 1},
  {user_id: 5, skill_id: 9, skill_level: 3},
  {user_id: 6, skill_id: 1, skill_level: 0},
  {user_id: 6, skill_id: 2, skill_level: 1},
  {user_id: 6, skill_id: 3, skill_level: 1},
  {user_id: 6, skill_id: 4, skill_level: 1},
  {user_id: 6, skill_id: 5, skill_level: 1},
  {user_id: 6, skill_id: 6, skill_level: 0},
  {user_id: 6, skill_id: 7, skill_level: 0},
  {user_id: 6, skill_id: 8, skill_level: 0},
  {user_id: 6, skill_id: 9, skill_level: 0},
  {user_id: 6, skill_id: 10, skill_level: 0},
  {user_id: 6, skill_id: 11, skill_level: 0},
  {user_id: 7, skill_id: 1, skill_level: 0},
  {user_id: 7, skill_id: 2, skill_level: 0},
  {user_id: 7, skill_id: 3, skill_level: 0},
  {user_id: 7, skill_id: 4, skill_level: 0},
  {user_id: 7, skill_id: 5, skill_level: 1},
  {user_id: 7, skill_id: 6, skill_level: 0},
  {user_id: 7, skill_id: 7, skill_level: 0},
  {user_id: 7, skill_id: 8, skill_level: 0},
  {user_id: 7, skill_id: 9, skill_level: 0},
  {user_id: 7, skill_id: 10, skill_level: 0},
  {user_id: 7, skill_id: 11, skill_level: 0},
  {user_id: 8, skill_id: 1, skill_level: 0},
  {user_id: 8, skill_id: 2, skill_level: 0},
  {user_id: 8, skill_id: 3, skill_level: 0},
  {user_id: 8, skill_id: 5, skill_level: 0},
  {user_id: 8, skill_id: 6, skill_level: 0},
  {user_id: 8, skill_id: 7, skill_level: 0},
  {user_id: 8, skill_id: 8, skill_level: 0},
  {user_id: 8, skill_id: 9, skill_level: 0},
  {user_id: 8, skill_id: 10, skill_level: 0},
  {user_id: 8, skill_id: 11, skill_level: 0},
  {user_id: 8, skill_id: 4, skill_level: 1}
])
